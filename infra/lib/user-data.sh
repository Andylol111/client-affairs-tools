...
umask 077
{
  ...
  echo "BEDROCK_RANK_MODEL_ID=us.anthropic.claude-haiku-4-5-20251001-v1:0"
  echo "BEDROCK_ALLOWED_MODEL_IDS=us.anthropic.claude-haiku-4-5-20251001-v1:0"
  echo "BEDROCK_CALLS_PER_CLUB_PER_HOUR=200"
  echo "ASSISTANT_REQUESTS_PER_MEMBER_PER_HOUR=15"
  echo "ASSISTANT_REQUESTS_PER_CLUB_PER_HOUR=120"
  echo "BEDROCK_INPUT_USD_PER_MILLION=1.00"
  echo "BEDROCK_OUTPUT_USD_PER_MILLION=5.00"
